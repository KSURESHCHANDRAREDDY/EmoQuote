...
fun SignupPage(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel)
{
    ...
    Column(
        ...
        Text(text = "EmoQuote", color = Color.Red, fontWeight = FontWeight.ExtraLight, fontFamily = FontFamily.Serif, fontSize = 40.sp)
        Spacer(modifier = Modifier.height(4.dp))
        Text(text = "Signup", fontSize = 21.sp, color = Color.Black)
        ...
        TextButton(onClick = {
            ...
            Text(text = "Have an account, Login", color = Color.Black)
        }
